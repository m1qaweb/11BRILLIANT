            ...
            <Link href="/profile" className="hidden lg:flex items-center gap-3 px-4 py-2 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all flex-1 max-w-md">
              ...
              <div className="flex-1 min-w-[100px]">
                <div className="flex items-center justify-between text-xs mb-1">
                  ...
                  <span className="font-semibold text-blue-200">{Math.round(progress?.progress_percent || 0)}%</span>
                </div>
          ...
          <div className="flex items-center gap-3">
            ...
            {loading ? (
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  href="/auth/signup"
                  className="btn-accent text-base px-6 py-2.5 shadow-xl hover:shadow-amber-500/30 georgian-body text-white"
                >
                  რეგისტრაცია
                </Link>
              </div>
