...
export const metadata = {
  title: 'შესვლა - გონი',
  description: 'შეისვეთ თქვენს ანგარიშში',
}
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden bg-[#0f172a]">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <h2 className="text-center text-3xl font-black text-white mb-8 georgian-heading tracking-tight text-glow">
          მოგესალმებით
        </h2>
      </div>
          ...
          {params.error && (
            <div className="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-xl animate-slide-up backdrop-blur-sm">
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm font-semibold text-red-200 georgian-body">{params.error}</p>
              </div>
            </div>
          )}
          ...
          <form action={signInAction} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <label
                  htmlFor="remember-me"
                  className="ml-3 block text-sm font-medium text-blue-200 georgian-body"
                >
                  დამახსოვრება
                </label>
              </div>
              ...
              <div className="text-sm">
                <Link
                  ...
                  className="font-bold text-primary hover:text-primary/80 transition-colors georgian-body"
                >
                  დაგავიწყდათ?
                </Link>
              </div>
